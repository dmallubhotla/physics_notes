...
%\begin{align}
%	\dv[0]{\frac{\ln(\eta \pm k\vf)}{k}}{k} &= \frac{\ln(\eta \pm k\vf)}{k}\\
%	\dv[1]{\frac{\ln(\eta \pm k\vf)}{k}}{k} &= \frac{\pm \vf}{k \left(\eta \pm k\vf \right)} - \frac{\ln(\eta \pm k\vf)}{k^2}\\
%	\dv[2]{\frac{\ln(\eta \pm k\vf)}{k}}{k} &= frac{}{}\\
%\end{align}
